...
必备分区:
/ 根分区
swap分区 交换分区，内存2倍，不超过2GB  ==> 我在当代Linux 上的固体硬盘中swap 到了62G 2026年注

推荐分区: 
/boot 启动分区， 200M , 专门为了启动，设置之后就不再写数据，保证永远有空间，永远可以启动,  实际上总有
不至于不设boot分区时，/根分区写满, 无法启动
